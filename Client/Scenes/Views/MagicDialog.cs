        ...
        public void Refresh()
        {
            ...
            if (MapObject.User.Magics.TryGetValue(Info, out magic))
            {
                ...
                else
                {
                    ...
                    {
                        case 0:
                            ExperienceLabel.Text = $"修炼值: {magic.Experience}/{magic.Info.Experience1}";
                            break;
                        case 1:
                            ExperienceLabel.Text = $"修炼值: {magic.Experience}/{magic.Info.Experience2}";
                            break;
                        case 2:
                            ExperienceLabel.Text = $"修炼值: {magic.Experience}/{magic.Info.Experience3}";
                            break;
                        default:
                            ExperienceLabel.Text = $"修炼值: {magic.Experience}/{(magic.Level - 2) * 500}";
                            break;
                    }
