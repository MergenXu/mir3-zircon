...
namespace Client.Scenes.Views
{
    public sealed class ChatOptionsDialog : DXWindow
    {
        ...
        public ChatOptionsDialog()
        {
            ...
            {
                DXMessageBox box = new DXMessageBox("你确定要重置所有聊天窗口吗？", "聊天重置", DXMessageBoxButtons.YesNo);
            ...
            button.MouseClick += (o, e) =>
            {
                ...
                GameScene.Game.ReceiveChat("聊天配置已保存", MessageType.Announcement);
            };
            ...
            button.MouseClick += (o, e) =>
            {
                DXMessageBox box = new DXMessageBox("你确定要重新加载所有聊天窗口吗？", "聊天重新加载", DXMessageBoxButtons.YesNo);
        ...
        public void CreateDefaultWindows()
        {
            ...
            tab.Panel.Text = $"频道 {ListBox.Controls.Count - 1}";
        }
        #endregion
